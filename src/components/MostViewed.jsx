    ...
    <div>
      <div className="mb-4">
        <h2 className="font-display text-lg md:text-3xl font-bold flex items-center gap-2">
          <span className="text-lg md:text-3xl">👀</span> Most Viewed Reviews
        </h2>
        <p className="text-lg md:text-xl font-semibold text-[var(--color-ink)]/85 mt-2">The reviews people read the most! My detailed info helps them decide where to eat.</p>
      </div>
